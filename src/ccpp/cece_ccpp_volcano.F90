module cece_ccpp_volcano
  ...
  use cece_ccpp_state, only: g_cece_data_ptr, g_init_count, g_initialized, &
    cece_ccpp_core_finalize, cece_ccpp_core_init, cece_ccpp_get_export_field, cece_ccpp_scheme_finalize, cece_ccpp_scheme_init, cece_ccpp_scheme_run, cece_ccpp_sync_export_to_host, cece_ccpp_sync_import_to_devic_ &
    &e
  implicit none
  private
