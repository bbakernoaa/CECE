...
contains
  ...
  subroutine cece_soil_nox_init(horizontal_loop_extent, vertical_layer_dimension, &
    ...
    call cece_fms_scheme_init(g_cece_data_ptr, 'soil_nox'//c_null_char, 8, &
      horizontal_loop_extent, 1, vertical_layer_dimension, rc)
    if (rc /= 0) then
      errflg = 1
  ...
  subroutine cece_soil_nox_run(horizontal_loop_extent, vertical_layer_dimension, &
    ...
    call cece_fms_set_import_field(g_cece_data_ptr, 'soil_moisture'//c_null_char, 13, &
    ...
    ! Execute scheme
    call cece_fms_scheme_run(g_cece_data_ptr, 'soil_nox'//c_null_char, 8, rc)
    if (rc /= 0) then; errflg = 1; errmsg = 'soil_nox_run: scheme run failed'; return; end if

    ! Marshal outputs
    call cece_fms_get_export_field(g_cece_data_ptr, 'EmissSoilNOx'//c_null_char, 12, &
  ...
  subroutine cece_soil_nox_finalize(errmsg, errflg)
    ...
    call cece_fms_scheme_finalize(g_cece_data_ptr, 'soil_nox'//c_null_char, 8, rc)
