...
contains
  ...
  subroutine cece_dms_init(horizontal_loop_extent, vertical_layer_dimension, &
    ...
    call cece_fms_scheme_init(g_cece_data_ptr, 'dms'//c_null_char, 3, &
      horizontal_loop_extent, 1, vertical_layer_dimension, rc)
    if (rc /= 0) then
      errflg = 1
  ...
  subroutine cece_dms_run(horizontal_loop_extent, vertical_layer_dimension, &
    ...
    ! Execute scheme
    call cece_fms_scheme_run(g_cece_data_ptr, 'dms'//c_null_char, 3, rc)
    if (rc /= 0) then; errflg = 1; errmsg = 'dms_run: scheme run failed'; return; end if

    ! Marshal outputs
    call cece_fms_get_export_field(g_cece_data_ptr, 'EmissDMS'//c_null_char, 8, &
  ...
  subroutine cece_dms_finalize(errmsg, errflg)
    ...
    call cece_fms_scheme_finalize(g_cece_data_ptr, 'dms'//c_null_char, 3, rc)
