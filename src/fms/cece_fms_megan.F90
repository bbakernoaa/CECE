module cece_fms_megan
  use iso_c_binding
  use cece_fms_state, only: g_cece_data_ptr, g_init_count, g_initialized
  implicit none
  private
...
contains
  ...
  subroutine cece_megan_init(horizontal_loop_extent, vertical_layer_dimension, &
    ...
    call cece_fms_scheme_init(g_cece_data_ptr, 'megan'//c_null_char, 5, &
      horizontal_loop_extent, 1, vertical_layer_dimension, rc)
    if (rc /= 0) then
      errflg = 1
  ...
  subroutine cece_megan_run(horizontal_loop_extent, vertical_layer_dimension, &
    ...
    call cece_fms_set_import_field(g_cece_data_ptr, 'ps'//c_null_char, 2, &
    ...
    call cece_fms_set_import_field(g_cece_data_ptr, 'soil_temperature'//c_null_char, 16, &
    ...
    call cece_fms_set_import_field(g_cece_data_ptr, 'lai'//c_null_char, 3, &
    ...
    call cece_fms_set_import_field(g_cece_data_ptr, 'solar_radiation'//c_null_char, 15, &
    ...
    ! Execute scheme
    call cece_fms_scheme_run(g_cece_data_ptr, 'megan'//c_null_char, 5, rc)
    if (rc /= 0) then; errflg = 1; errmsg = 'megan_run: scheme run failed'; return; end if

    ! Marshal outputs
    call cece_fms_get_export_field(g_cece_data_ptr, 'EmissMEGAN_ISOP'//c_null_char, 15, &
  ...
  subroutine cece_megan_finalize(errmsg, errflg)
    ...
    call cece_fms_scheme_finalize(g_cece_data_ptr, 'megan'//c_null_char, 5, rc)
